        ...
        <Layout>
            ...
            <div className="relative w-full h-full flex flex-col">
                <div className="basis-1/3 text-white flex justify-between pt-[24vh] px-4 md:px-8">
                    ...
                    Empara is a movement and choreography company focused on creating nontraditional contemporary dance experiences. Empara celebrates other art forms and encourages all bodies to connect to their innate desire to move.
                    <br />
                    <br />
