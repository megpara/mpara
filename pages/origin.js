                ...
                <div className="relative z-[-1]">
                    <div className="text-white flex justify-between pt-[24vh] px-4 md:px-8">
                        ...
                        <div className="basis-1/2 italic lowercase text-[#bab5b1] text-sm">
                            Mpara originates from the Latin word &quot;emparer,&quot; meaning to take posession of something
                            <br />
                            <br />
                            Mpara takes possesion of the human form, the skin and what it holds, emotions, lineage, and the oneness that connects all beings
                        </div>
                    </div>
                    <div className="text-white flex justify-between pt-[24vh] pb-[12vh] px-4 md:px-8">
                        ...
                        <div className="basis-1/2 italic lowercase text-[#bab5b1] text-sm text-justify">
