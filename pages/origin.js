            ...
            <Head>
                ...
                <div className="relative z-[-1]">
                    ...
                    <div className="text-white block md:flex justify-between pt-[24vh] pb-[12vh] px-4 md:px-8">
                        <Image src="/headshot.png" alt="Megan Paradowski" className="basis-1/2 max-w-full md:max-w-[400px] object-cover pb-8" width={400} height={300}/>
                        <div className="basis-1/2 text-[#bab5b1] text-sm text-justify italic">
                            ...
                            <br />
                            <br />
                            Megan also works to bring avant-garde movement to the entertainment industry, where she has worked on commercial photo and video shoots including CloZee, Loren Stewart, and Undesigned LA. Megan is interested in collaborating with other artists and celebrating other forms, as well as transcendence through live performance. She holds a BFA in Dance from Tisch School of the Arts at NYU, and she has taught as a professor of dance at the University of Redlands, as well as at schools across Los Angeles such as South Pasadena High School and Genesis Studios.
                        </div>
                    </div>
                </div>
        </Layout>
