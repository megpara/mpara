        ...
        <Layout>
                <div className="relative z-[-1]">
                    <div className="text-white flex justify-between pt-[24vh] px-4 md:px-8">
                        <div className="basis-1/2 font-display uppercase text-4xl tracking-widest">Origin</div>
                    ...
                    <div className="text-white block md:flex justify-between pt-[24vh] pb-[12vh] px-4 md:px-8">
                        <img src="/headshot.png" className="basis-1/2 max-w-full md:max-w-[400px] object-cover pb-8"/>
